...
const PaymentButtons = ({ value, setValue, type = "others", cardStyle = {}, style = {}}) => {
    ...
    >
      <TouchableOpacity
        ...
        style={[
          ...
          {
            backgroundColor:
              value === "cash" ? light.main2 : mode === "light" ? light.main5 : dark.main2,
          },
        ]}
      >
        <Ionicons
      ...
      <TouchableOpacity
        style={[
          ...
          {
            backgroundColor:
              value === "card" ? light.main2 : mode === "light" ? light.main5 : dark.main2,
          },
        ]}
