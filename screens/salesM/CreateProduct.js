...
import { add, edit, remove } from "@features/sales/productsSlice";
import { addProduct, editProduct, removeProduct } from "@api";
...
const CreateProduct = ({ navigation, route }) => {
  ...
  useEffect(() => {
    const filtered = groups.filter((g) => g.type === "sales");
