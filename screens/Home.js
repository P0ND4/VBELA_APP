...
const Home = ({ navigation }) => {
  ...
  useEffect(() => {
    ...
    setMonths(language[code]["months"]);
  }, []);
        ...
        <View style={{ flexDirection: "row" }}>
          {activeGroup.active && (
            <TouchableOpacity
              onPress={() =>
                Alert.alert(
                  translate.leaveGroup.title,
                  translate.leaveGroup.description,
                  [
                    {
        ...
        <View style={styles.content}>
          {(!activeGroup.active ||
            ...
            <View>
              ...
              >
                <TextStyle color={light.textDark}>{translate.production}</TextStyle>
              </ButtonStyle>
          ...
          {(!activeGroup.active || activeGroup.accessToRoster) && (
            <View>
              <ButtonStyle
                ...
                backgroundColor={light.main2}
              >
                <TextStyle color={light.textDark}>{translate.payrollPayments}</TextStyle>
              </ButtonStyle>
              <Image source={Premium} style={styles.premium} />
            </View>
          )}
          {(!activeGroup.active || activeGroup.accessToTables) && (
            <View>
              <ButtonStyle
                ...
                backgroundColor={light.main2}
              >
                <TextStyle color={light.textDark}>{translate.menu}</TextStyle>
              </ButtonStyle>
              <Image source={Premium} style={styles.premium} />
            </View>
          )}
            ...
            <View style={styles.places}>
              ...
              {groups.length === 0 && (
                <ButtonStyle
                  ...
                  backgroundColor={light.main2}
                >
                  <TextStyle>{translate.addCategory}</TextStyle>
                </ButtonStyle>
              )}
            </View>
          )}
